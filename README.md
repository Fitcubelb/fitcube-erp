...
- **Profit &amp; loss** — the Overview tab (owner only) shows gross profit (all revenue minus what sold products actually cost you), a revenue breakdown, money spent restocking, and current inventory value at cost — so you can see what the business is actually making, not just what's coming in.
...
- **It reminds you.** The app remembers when you last saved a backup and shows the date in Settings. If it's been more than a week, a warning appears on the Overview tab with a button straight through to it — so this doesn't quietly stop happening.
