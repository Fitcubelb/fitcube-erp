...
- **Profit at a glance, owner only** — Overview shows total profit made all time, plus a Today / This week / This month / This year toggle right below it for however you want to check in. Profit here is revenue minus cost of goods sold, the same definition used on the Accounting page — this is just a faster way to see it without leaving Overview. Staff accounts never see this, on the server as well as in the UI.
